...
#        if (filingDataLine.find('2014/') >= 0 or filingDataLine.find('2013/') >= 0 or filingDataLine.find('2012/') >= 0):
        if (filingDataLine.find('2014/2') >= 0):
...
#MN,MS
srchState = 'IA'
# MN, NC, NJ, MA, MS, MO WA, WV, OR, OK
#print legalNameOpts

destPath = 'C:\\Users\\amanchanda\\Downloads\\Research\\Video_05262015\\Data\\'
dataFileName = destPath + srchState + '_3FilingData.txt'
dataFile = open(dataFileName,'a');

dataFileNameHist = destPath + srchState + '_3FilingData_Hist.txt'
dataFileHist = open(dataFileNameHist,'a');

communityFilename = destPath +  srchState + '_3AssocCommunities' + '.txt'
...
# Write the header
dataFile.writelines("State|Community|Id|FilingPeriod|SA|ReceiptDate|GrossReceipts|FilingFee|RoyaltyPayment|Interest|1stSetSubscr|1stSetRate|Correspondence?|FileAvailable?|LegalName\n")
dataFileHist.writelines("State|Community|Id|FilingPeriod|SA|ReceiptDate|GrossReceipts|FilingFee|RoyaltyPayment|Interest|1stSetSubscr|1stSetRate|Correspondence?|FileAvailable?|LegalName\n")
processedSystemId = []
srchCommunities= ['A','B','C','D','E','F','G', 'H', 'I', 'J', 'K' ,'L', 'M', 'N','O','P', 'Q']
#srchCommunities= [ 'R','S','T', 'U','V','W','X','Y','Z']
#srchCommunities= ['A','B','C','d','E','F']
#srchCommunities= ['G', 'H', 'I', 'J', 'K' ,'L']
#srchCommunities= ['M', 'N','O','P', 'Q', 'R']
#srchCommunities= ['S','T', 'U','V','W','X','Y','Z']
#srchCommunities= ['']
